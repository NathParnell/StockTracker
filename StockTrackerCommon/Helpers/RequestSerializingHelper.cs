...
namespace StockTrackerCommon.Helpers
{
    public static class RequestSerializingHelper
    {
        ...
        public static string CreateUpdateCustomerRequest(Customer customer, string portNumber)
        {
            string methodName = "UpdateCustomer";
            object[] data = new object[] { customer };
            return CreateRequest(methodName, data, portNumber);
        }
        ...
        public static string CreateAddOrderItemsRequest(List<OrderItem> orderItems, string portNumber)
        {
            string methodName = "AddOrderItems";
            object[] data = new object[] { orderItems };
            return CreateRequest(methodName, data, portNumber);
        }
        ...
        public static string CreateGetOrdersByUserIdRequest(string userId, string portNumber)
        {
            string methodName = "RetrieveOrdersByUserId";
            object[] data = new object[] { userId };
            return CreateRequest(methodName, data, portNumber);
        }
